...
class Predmet extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nazov, fakulta, katedra', 'required'),
			array('nazov, fakulta, katedra', 'length', 'max'=>60),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nazov, fakulta, katedra', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'userPredmets' => array(self::HAS_MANY, 'UserPredmet', 'id_predmet'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nazov',$this->nazov,true);
		$criteria->compare('fakulta',$this->fakulta,true);
		$criteria->compare('katedra',$this->katedra,true);
